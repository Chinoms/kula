 ...
 <main>
                     ...
                     <div class="row">
                         <div class="col-xl-8 col-lg-9 col-md-11 col-sm-10">
                             <div class="hero__caption">
                                 <span data-animation="fadeInUp" data-delay="0.2s">OUR HISTORY</span>
             ...
             <div class="single-slider slider-height d-flex align-items-center">
                 <div class="container">
                     <div class="row">
                         <div class="col-xl-8 col-lg-9 col-md-11 col-sm-10">
                             <div class="hero__caption">
                                 <span data-animation="fadeInUp" data-delay="0.2s">Beautiful People of Kula</span>
                                 <h1 data-animation="fadeInUp" data-delay="0.5s">Learn About Kula</h1>
                             </div>
                         </div>
                     </div>
                 </div>
     ...
     <section class="sample-text-area">
         <div class="container box_1170">
             <h3 class="text-heading">Migration and Historical Background</h3>
             <p class="sample-text">
                 The origin of the people now known as Kula in the Eastern Niger Delta area dates back to many centuries ago with a long chequered history.
                 The exact time of the movement from their remote ancestral homelands into the Eastern Niger Delta base to establish the Kula Kingdom is, however, not easy to come by for some prevalent reasons, being a pre-literate period.
                 History has it that Kula is an amalgam of fourteen (14) ancient independent communities scattered around the present Kula territory.
                 These include: Opu-Kula, Boro, Nangwo-ama, Kongo-ama, Kilama/Diaba/Offo, Isoma, Ingeje, Owuangaye, Ibiame(Agudame), Tubo, Ariame, Obiame etc.
                 Today, these and other over 100 fishing villages/settlements (scattered within the 14 major communities) combine with the present Kula Town (Anyame-Kula) to make up the Kula Kingdom.
                 The migration of the Kula people has a long history. Most accounts on Kula history hardly go beyond the old Kula federation of fourteen communities, probably because of the complex history.
                 There were movements before they arrived in the present territory in the eastern Niger Delta. For convenience, the migration traditions of the Kula people can be briefly viewed in two broad angles as narrated below. One group comprising a set of ijaw (ijo) settlers were traced to the Iselema area in the western Niger Delta in the present day Delta State of Nigeria. Some writers even refer to an earlier movement from the central delta into the western delta.They moved from Iselema (western delta) through the Ita-Kula axis to the present territory. However, details of the series of movements were not clearly captured even as the cause(s) of such movements was not clearly known; it might be connected with external attacks, intra-group conflicts, pestilence, or floods. Given the long distance between the western delta and the present domain, we also expect different temporal settlements along the line if this account is to be accepted. When they arrived in this part of the eastern delta, they settled in their individual families at different locations (which constituted part of the 14 major communities), occasionally meeting at Opu-Kula, which served as the capital, for issues of mutual interests or for other social purposes. It is claimed that it is because of this origin that Kula is sometimes called Suku Iselema (Southern Iselema or Iselema South, of sorts)
